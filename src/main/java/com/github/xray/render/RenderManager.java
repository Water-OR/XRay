...
public class RenderManager {
        ...
        public static void render(float particleTick) {
                ...
                Controller.ores.forEach(RenderManager::renderBlock);
        ...
        public static void renderBlock(@NotNull Vec3i pos, @NotNull Color color) {
                final int xMin = pos.getX(), xMax = xMin + 1;
                final int yMin = pos.getY(), yMax = yMin + 1;
                final int zMin = pos.getZ(), zMax = zMin + 1;
                
                GL11.glBegin(GL11.GL_LINES);
                color.progressGLAlpha(XRayConfig.fade ? Math.max(0, (XRayConfig.radius - distanceTo(pos)) / XRayConfig.radius) : 1D);
